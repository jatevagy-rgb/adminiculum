...
const evidenceControl: ControlEntry = {
  ...
  evidence: [
    { id: "ev_1", title: "Felülvizsgálati jegyzőkönyv", status: "ACCEPTED", sourceType: "DOCUMENT_VERSION", validFrom: null, validUntil: null, freshness: "CURRENT" },
    { id: "ev_2", title: "Külső szabályzat", status: "PROVIDED", sourceType: "EXTERNAL_REFERENCE", validFrom: null, validUntil: null, freshness: "CURRENT" },
  ],
};
...
describe("compliance evidence recording and review workforce UI", () => {
  ...
  it("EVIDENCE_REVIEW_ACTIONS_ONLY_FOR_PENDING: accepted evidence shows no accept/reject affordance", () => {
    const onlyAccepted: ControlEntry = {
      ...evidenceControl,
      evidence: [{ id: "ev_1", title: "Elfogadott jegyzőkönyv", status: "ACCEPTED", sourceType: "EXTERNAL_REFERENCE", validFrom: null, validUntil: null, freshness: "CURRENT" }],
    };
