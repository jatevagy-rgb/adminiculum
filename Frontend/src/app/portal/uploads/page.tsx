  ...
  return (
    <PortalMockShell>
      <PortalPageHero
        ...
        title="Inaktív, szintetikus ügyfélteendők."
            ...
            <article key={`${request.title}-${request.dueDate}`} className="rounded-3xl border border-[var(--adm-border)] bg-white p-5 shadow-[var(--adm-shadow-md)]">
              <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm text-[var(--adm-text-muted)]">Határidő: {request.dueDate}</p>
                </div>
              ...
              <div className="mt-5 rounded-2xl bg-[var(--adm-surface)] p-4 text-sm leading-6 text-[var(--adm-text-muted)]">
                Fájl kiválasztása, beküldés és tárhelykapcsolat nincs ezen az oldalon.
              </div>
              <div className="mt-5">
