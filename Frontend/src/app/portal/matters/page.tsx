...
import { mockMatters } from "../mockPortalData";
  ...
  return (
    <PortalMockShell>
      <PortalPageHero
        ...
        title="Szintetikus ügylista, kizárólag ügyféloldali nézettel."
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 lg:grid-cols-3">
          {mockMatters.map((matter) => (
            <article key={matter.externalId} className="flex min-h-[300px] flex-col rounded-3xl border border-[var(--adm-border)] bg-white p-5 shadow-[var(--adm-shadow-md)]">
