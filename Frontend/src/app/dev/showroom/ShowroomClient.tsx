            ...
            <AdminPanel className="p-6 space-y-6">
              <div>
                <h4 className="text-xs font-bold uppercase tracking-wider text-[var(--adm-text-secondary)] mb-3">
                  AdminButton Változatok (Hierarchia szerint besorolva)
                </h4>
                <div className="flex flex-wrap items-center gap-3">
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded font-bold">PREFERRED</span>
                    <AdminButton variant="primary">Elsődleges (primary)</AdminButton>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded font-bold">PREFERRED</span>
                    <AdminButton variant="neutral">Semleges (neutral)</AdminButton>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded font-bold">PREFERRED</span>
                    <AdminButton variant="danger">Törlés (danger)</AdminButton>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-bold">SPECIAL PURPOSE</span>
                    <AdminButton variant="ai">AI Művelet (ai)</AdminButton>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-amber-100 text-amber-800 px-1.5 py-0.5 rounded font-bold">SUPPORTED LEGACY</span>
                    <AdminButton variant="gold">Kiemelt (gold)</AdminButton>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-amber-100 text-amber-800 px-1.5 py-0.5 rounded font-bold">SPECIAL PURPOSE</span>
                    <AdminButton variant="warning">Figyelmeztető (warning)</AdminButton>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-neutral-100 text-neutral-700 px-1.5 py-0.5 rounded font-bold">SUPPORTED LEGACY</span>
                    <AdminButton variant="ghost">Csendes (ghost)</AdminButton>
                  </div>
                  <div className="flex flex-col gap-1 items-start">
                    <span className="text-[10px] font-mono uppercase bg-neutral-100 text-neutral-700 px-1.5 py-0.5 rounded font-bold">DISABLED</span>
                    <AdminButton variant="primary" disabled>Inaktív</AdminButton>
                  </div>
                </div>
              </div>
            ...
            <AdminPanel className="p-6 space-y-6">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-[10px] font-mono uppercase bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded font-bold">PREFERRED (CANONICAL)</span>
                  <h4 className="text-xs font-bold uppercase tracking-wider text-[var(--adm-text-secondary)]">
          ...
          <section id="surfaces" className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <AdminPanel className="p-4">
                <span className="inline-block mb-2 text-[10px] font-mono uppercase bg-emerald-100 text-emerald-800 px-1.5 py-0.5 rounded font-bold">PREFERRED (CANONICAL)</span>
                <h3 className="text-sm font-semibold text-[#0F3D32]">Kanonikus AdminPanel</h3>
                <p className="mt-1 text-xs text-[var(--adm-text-secondary)]">
                  8px lekerekítés, diszkrét 1px keret, tiszta fehér háttér. Alapértelmezett operatív felület jogi adatokhoz.
                </p>
              ...
              <Card>
                <CardHeader>
                  <span className="inline-block mb-1 text-[10px] font-mono uppercase bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-bold">SPECIAL PURPOSE</span>
                  <CardTitle>Strukturált Kártya (Card)</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-xs text-[var(--adm-text-secondary)]">
                    12px kerekítésű UI kártya tagolt fejléccel és törzzsel önálló összegző dobozokhoz (ne ágyazzuk egymásba).
                  </p>
                </CardContent>
              ...
              <AdminPanel className="p-4 bg-[var(--adm-canvas-subtle)] border-dashed">
                <span className="inline-block mb-2 text-[10px] font-mono uppercase bg-neutral-100 text-neutral-700 px-1.5 py-0.5 rounded font-bold">SUPPORTED LEGACY</span>
                <h3 className="text-sm font-semibold text-neutral-700">Kompakt műveleti doboz</h3>
                <p className="mt-1 text-xs text-[var(--adm-text-secondary)]">
                  Másodlagos kontextuális információk és gyors állapot-összegzések részére.
                </p>
                <div className="mt-3">
