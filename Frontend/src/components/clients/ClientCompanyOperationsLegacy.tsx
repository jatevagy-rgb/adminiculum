...
export function ClientCompanyOperationsLegacy({ clientId, clientName }: { clientId: string; clientName: string }) {
  ...
  return (
    <div className="space-y-5" data-testid="client-company-operations-legacy">
      ...
      <header className="rounded-[var(--adm-radius-md)] border border-[#DCCCA6] bg-[var(--adm-sand-100)] p-5">
        <p className="text-[10px] uppercase tracking-[0.2em] text-[var(--adm-green-800)]">Operatív áttekintés</p>
      ...
      {!loading && !error && overview ? (
        <>
          ...
          <Panel id="legacy-compliance" title="Releváns területek">
            {complianceLoading ? (
