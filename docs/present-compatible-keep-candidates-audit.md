...
- This does not move client identity fields, `cases.clientRole`, Client Portal, external client visibility, `workload_records`, or `documents.workspaceText` out of their prior lanes.
