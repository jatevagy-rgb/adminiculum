...
- Whether public OpenAPI JSON, Power Apps connector specs, and CORS behavior should be public, authenticated, admin-only, disabled, or narrowed before any production-compatible baseline `KEEP` decision.
