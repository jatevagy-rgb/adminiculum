 ...
 *
 * The customer matter detail may only be composed from explicitly published,
 * customer-safe sources: the immutable current ClientMatterPublicationRevision,
 * PUBLISHED ClientDocumentPublication rows, PUBLISHED ClientActionRequest rows,
 * PUBLISHED ClientSafeUpdate rows and the published milestones snapshot.
 * Internal Case/Task/deadline/communication data must never enter this path.
 */
