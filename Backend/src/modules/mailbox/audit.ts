...
export const MAILBOX_AUDIT_EVENTS = ['MAILBOX_VERIFICATION_STARTED', 'MAILBOX_VERIFIED', 'MAILBOX_AUTHORIZATION_STARTED', 'MAILBOX_CONNECTED', 'MAILBOX_SYNC_STARTED', 'MAILBOX_SYNC_SUCCEEDED', 'MAILBOX_SYNC_FAILED', 'MAILBOX_SEND_SUCCEEDED', 'MAILBOX_SEND_FAILED', 'MAILBOX_REAUTH_REQUIRED', 'MAILBOX_IDENTITY_UNAVAILABLE', 'MAILBOX_IDENTITY_MISMATCH', 'MAILBOX_TARGET_ACCESS_DENIED', 'MAILBOX_TARGET_NOT_FOUND', 'MAILBOX_TARGET_UNAVAILABLE', 'MAILBOX_SHARED_TARGET_AUTHORIZED', 'MAILBOX_DISCONNECTED', 'MAILBOX_REVOKED'] as const;
