...
function createNeutralizedVariant(xml, paragraph, variantName) {
...
console.log('=== DOCX Isolation Test ===');
...
for (const partName of partNames) {
  ...
  for (let i = 0; i < paragraphs.length; i++) {
    ...
    const neutralizedXml = createNeutralizedVariant(xml, paragraph, variantName);
